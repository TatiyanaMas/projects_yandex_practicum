...
В рамках проекта проведен анализ данных использования мобильного приложения по аренде самокатов. Обработаны данные датасетов. Проведена визуализация данных. Для формирования пайплайнов были использованы следующие модели:
